...
public class MethodoProduct {
	...
	private String[] getColumnProduct() {
		String[] columnProduct = { "internal_code" , "barcode" , "name", "description" , "type" , "type2" , "cost" , "price" , "ncm" , "cfop" , "tax4_code" , "tax1_code" , "tax1" , "tax2_code" , "tax2" , "tax3_code" , "tax3" , "current_stock" };
